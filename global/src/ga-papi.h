...
extern void pnga_matmul_patch_alt(char *transa, char *transb, void *alpha, void *beta, Integer g_a, Integer alo[], Integer ahi[], Integer g_b, Integer blo[], Integer bhi[], Integer g_c, Integer clo[], Integer chi[]);
...
extern Integer pnga_sprs_array_create_from_dense(Integer g_a, Integer idx_size,
    Integer trans);
extern Integer pnga_sprs_array_create_from_sparse(Integer s_a, Integer trans);
...
extern Integer pnga_sprs_array_elementwise_multiply(Integer s_a, Integer s_b);
...
extern logical pnga_sprs_array_activate_relu(Integer s_a, void *bias,
    void **categories, void *features);
extern Integer pnga_sprs_array_sprsdns_multiply(Integer s_a, Integer g_b,
    Integer trans);
extern Integer pnga_sprs_array_dnssprs_multiply(Integer g_a, Integer s_b,
    Integer trans);
extern void pnga_sprs_array_sampled_multiply(Integer g_a, Integer g_b, Integer s_c,
    Integer transB, Integer trans);
extern Integer pnga_sprs_array_quantize256(Integer s_a, void *max);
#endif /* PAPI_H_ */
