...
extern int           NGA_Sprs_array_activate_ReLU(int s_a, void *bias,
                        int **categories, int *features);
extern int           NGA_Sprs_array_activate_ReLU64(int s_a, void *bias,
                        int64_t **categories, int64_t *features);
...
extern int           NGA_Sprs_array_create_from_sparse(int s_a);
...
extern int           NGA_Sprs_array_elementwise_multiply(int s_a, int s_b);
...
extern int           NGA_Sprs_array_quantize256(int s_a, void *max);
extern void          NGA_Sprs_array_row_distribution(int s_a, int iproc, int *lo, int *hi);
extern void          NGA_Sprs_array_sampled_multiply(int g_a, int g_b, int s_a,
                        int transB);
